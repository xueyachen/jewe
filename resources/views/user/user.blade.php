...
<html lang="zh-cn">
  ...
  <body>
    <div class="maincont">
     <div class="userName">
      <dl class="names">
       <dt><img src="/jewell/images/user01.png" /></dt>
       <dd>
        <h3>天池不动峰</h3>
       </dd>
     ...
     <ul class="userNav">
      ...
      <div class="state">
         <dl>
          <dt><a href="order.html"><img src="/jewell/images/user1.png" /></a></dt>
          <dd><a href="order.html">待支付</a></dd>
         </dl>
         <dl>
          <dt><a href="order.html"><img src="/jewell/images/user2.png" /></a></dt>
          <dd><a href="order.html">代发货</a></dd>
         </dl>
         <dl>
          <dt><a href="order.html"><img src="/jewell/images/user3.png" /></a></dt>
          <dd><a href="order.html">待收货</a></dd>
         </dl>
         <dl>
          <dt><a href="order.html"><img src="/jewell/images/user4.png" /></a></dt>
          <dd><a href="order.html">全部订单</a></dd>
         </dl>
         <div class="clearfix"></div>
      </div><!--state/-->
      <li><span class="glyphicon glyphicon-usd"></span><a href="quan.html">我的优惠券</a></li>
      <li><span class="glyphicon glyphicon-map-marker"></span><a href="/index/addresslist">收货地址管理</a></li>

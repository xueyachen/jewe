  ...
  <body>
    <div class="maincont">
     ...
     <div class="head-top">
      ...
      <div class="lrBox">
       <div class="lrList"><input type="text" placeholder="收货人" name="address_name" class="name"/></div>
       ...
       <div class="lrList"><input type="text" placeholder="详细地址" name="address_detail" class="detail"/></div>
       <div class="lrList"><input type="text" placeholder="手机" name="address_tel" class="tel"/></div>
       <div class="lrList2">
           设为默认<input type="checkbox" name="is_default" checked>
       </div>
      </div><!--lrBox/-->
      <div class="lrSub">
